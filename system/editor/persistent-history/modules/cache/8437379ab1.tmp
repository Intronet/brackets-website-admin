...
define(function (require) {
   ...
   if(
      prefs_.get("history") === undefined || 
      prefs_.get("history") === false ||
      PF.getExtensionPrefs("petetnt.brackets-persistent-history").get("persistHistory") === true
      ){
      return false;
   }
   ...
   var prefs = PreferencesManager.getExtensionPrefs('brackets-website-admin.history'); //COMMAND_ID);
